...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TH1D *hsignal_bjets[nfile];
   TH1D *hsignal_doubleB[nfile];
   TH1D *hsignal_doubleB_highdB[nfile];
   TH1D *hsignal_bjetprob[nfile];
   TH1D *hsignal_bjetprob2[nfile];
   TH1D *hsignal_bjetCSV[nfile];
   TH1D *hsignal_bjetCSV2[nfile];
   TH1D *hsignal_bjetcMVA[nfile];
   TH1D *hsignal_bjetcMVA2[nfile];

   TH1D *hsignal_HT_before[nfile];
   TH1D *hsignal_EMHT_before[nfile];
   TH1D *hsignal_HT_after[nfile];
   TH1D *hsignal_EMHT_after[nfile];

   TH1D *hsignal_AK8HT_before[nfile];
   TH1D *hsignal_AK8EMHT_before[nfile];
   TH1D *hsignal_AK8HT_after[nfile];
   TH1D *hsignal_AK8EMHT_after[nfile];
...
#ifdef mc_signal_cxx
mc_signal::mc_signal(TTree *tree) : fChain(0) 
{
...
Int_t mc_signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mc_signal::LoadTree(Long64_t entry)
{
...
void mc_signal::Init(TTree *tree)
{
...
void mc_signal::Show(Long64_t entry)
{
...
Int_t mc_signal::Cut(Long64_t entry)
{
