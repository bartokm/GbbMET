...
double get_cross_section(std::string name, std::string y, int center_down_up=0) {
  ...
  else if (name.find("ZGToLLG_01J_5f_TuneCP5")!=std::string::npos) return 51.1;
  else if (name.find("ZGToLLG_01J_5f_PtG-130")!=std::string::npos) return 0.1602; //own calculation
  else if (name.find("ZGTo2NuG_TuneCP5")!=std::string::npos) return 30.18;
  else if (name.find("ZGTo2NuG_PtG-130")!=std::string::npos) return 0.2814; //own calculation
