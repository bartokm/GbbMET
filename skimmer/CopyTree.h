...
// Tue Feb 13 11:40:56 2018 by ROOT version 5.34/36
// from TTree EventTree/Event data (tag V08_00_26_06)
// found on file: ../../ggntuples/BkgMC/V08_00_26_07/QCD/QCD_HT200to300_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/0005/ggtree_mc_5153.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Double_t Cross_Section=1;
   unsigned int nFiles=0;

   CopyTree(std::vector<std::string> arg={"default"}, std::string outname={"default"}, Double_t cross_section=1);
   virtual ~CopyTree();
...
#ifdef CopyTree_cxx
CopyTree::CopyTree(std::vector<std::string> arg, std::string outname, Double_t cross_section) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
  TTree *tree;
  TChain * ch = new TChain("EventTree","");
  std::string temp_fname="CopyTree_skimmed";
  ...
  if (arg.at(0)=="default") {
    const char* fdefault = "/data/gridout/mbartok/Analysis/Data/CMSSW8026p1/Run2016D_SinglePhoton_filtered/SinglePhoton/ggNtuple_V08_00_26_02/170309_111834/0000/ggtree_data_1.root/ggNtuplizer/EventTree";
...
Int_t CopyTree::Cut(Long64_t entry)
{
